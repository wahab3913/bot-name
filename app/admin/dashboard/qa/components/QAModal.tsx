...
export default function QAModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm overflow-y-auto h-full w-full z-50 flex items-center justify-center p-2 md:p-4">
              ...
              <div>
                ...
                {editingQA && (
                  <p className="text-xs text-gray-500 mt-2">
                    Question cannot be changed when editing. Only the answer can
                    be updated.
                  </p>
                )}
              </div>
